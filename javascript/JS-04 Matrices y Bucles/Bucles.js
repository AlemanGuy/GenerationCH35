...
/*
// Ciclo for 
Un ciclo for se repite hasta que la condicion se evalue como un false. Crea 3 expresionales opcionales
*Sinttaxis
    *for (expresioninicial; expresioncondicional; exprecionactualizacion;){
        Codigo a ejecutar en cada iteracion del bucle
    }
    1.- Inicializacion: se debe de inicializar con una variable que sera evaluada en la expresion o comaparar.
    2.-Condicion: es una expresion que debe de cumplir la variable inicial (true), si no se cumple (false) el bucle termina.
...
// Programa para vender bolo9r con una variable global
let bolos = 1;

for(bolos; bolos <= 35; bolos ++){
...
/*
    ...
    Debemos usar indicies del arreglo para poder usar el bucle, en indices dede el 0 hasta n y usaremos la propiedad length
*/
...
/*
    Variacion del ciclo for
    for.. of nos permite recorrer el objeto (array) y devulve el valor
    for.. in nos permite recorrer el objeto (array) y devuelve su posicion (indices)
*/

let frutas = ["Manzana", "Naranaja", "Peras", "Mandarinas", "Uvas"];
...
for (let i = 1; i<= 10; i++){
    ...
    console.log(`${tabla} x ${resultado}`);
}

// Ciclo while
/*
    Recorrer un bloque de codigo siempre que una condicion especifica sea verdadera.
    Sirve para realizar una tarea repetitiva mientras una condicon sea verdad.
*/ 
